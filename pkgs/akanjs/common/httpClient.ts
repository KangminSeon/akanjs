...
export class HttpClient {
  ...
  async get<Returns>(url: string, options?: HttpRequestOptions): Promise<Returns> {
    return await this.#request<Returns>("GET", url, undefined, options);
  }

  async post<Returns>(url: string, data?: unknown, options?: HttpRequestOptions): Promise<Returns> {
    return await this.#request<Returns>("POST", url, data, options);
  }

  async put<Returns>(url: string, data?: unknown, options?: HttpRequestOptions): Promise<Returns> {
    return await this.#request<Returns>("PUT", url, data, options);
  }

  async delete<Returns>(url: string, options?: HttpRequestOptions): Promise<Returns> {

...
You are writing an Akan.js model dictionary file.

Model constant:
\`\`\`typescript
// File: lib/${modelName}/${modelName}.constant.ts
${constant}
\`\`\`
...
Complete the dictionary according to the constant file and boilerplate below.
Return only file results in parseable code blocks.

\`\`\`typescript
// File: lib/${modelName}/${modelName}.dictionary.ts
${boilerplate}
\`\`\`
`;
